...
\begin{enumerate}
	...
	\item choisir la famille de copulas qui correspond à la structure de dépendance observée \parencite{Nelsen2006}.
\end{enumerate}

\begin{rkbox}
	Ce choix est le plus compliqué à mettre en \oe uvre car je ne sais pas vraiment comment le coder en R. Il y a des infos dans les posts de \href{https://bggj.is/posts/stan-copulas-1/}{bggj}.
\end{rkbox}
