...
The equation of interest is the 6th from @zhou as everything derives from it. Starts from the following equation which is *mutatis mutandis* the allometric equation:
$$
y = a x^{\psi}.
$$ {#eq-allometric}
...
y = \frac{x}{m - d\exp[-kx]},
$$
\ie $m - d\exp[-kx]$ is the ratio $y/x$ (see notebook 2, 25.03.2025, p. 45--47 for more details).


<!-- RESTART FROM HERE -->
. If I understood well, I should process as follow:
