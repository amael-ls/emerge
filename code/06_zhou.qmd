...
I use data collected in 2009 in Bure (France), and in 2010 (unknown location). The preparation of the data is detailed in the document `01_prepare_data.qmd`.
...
for (current_sp in c("Fagus sylvatica", "Quercus petraea")) # The only two species in common
{
	...
	loglik_beta = betareg_loglik$generate_quantities(fitted_params = fit$draws(inc_warmup = FALSE),
	...
	saveRDS(loo_beta, paste0("./loo_beta-", current_sp, ".rds")
}
