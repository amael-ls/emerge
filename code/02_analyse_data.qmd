...
plot(forest_dt[, log(circumference_m)], forest_dt[, log(bole_volume_m3)], col = forest_dt[, fct_colour], pch = 19,
	xlab = "Circumference", ylab = "Bole volume", asp = 1, axes = FALSE)
legend(x = "topleft", bty = "n", legend = c("Broadleaf", "Conifer"), fill = colours[c("broadleaf", "conifer")])
axis(1)
axis(2, las = 1)
...
plot(density(aa), lwd = 2, lty = "dashed", ylim = c(0, 0.82), col = "#0F7BA2", main = "", axes = FALSE, xlab = "x")
lines(density(bb), lwd = 2, lty = "dashed", col = "#0F7BA2")
lines(density(cc), lwd = 5)
curve(dlnorm(x, test["mu"], test["sigma"]), lwd = 2, col = "#CD212A", add = TRUE)
legend(x = "topright", legend = c("logN(1, 0.25)", "logN(0.21, 0.42)", "Sum", "Approx"),
	lwd = 3, bty = "n", col = c("#0F7BA2", "#0F7BA2", "black", "#CD212A"))
axis(1, at = seq(0, 8, 2))
axis(2, las = 1)
```
...
plot(density(approx_dt[, res_bole_m3]), lwd = 2, xlab = "Residuals", axes = FALSE, main = FALSE)
axis(1)
axis(2, las = 1)
plot(density(approx_dt[, res_crown_m3]), lwd = 2, xlab = "Residuals", axes = FALSE, main = FALSE)
axis(1)
axis(2, las = 1)
plot(density(approx_dt[, res_tot_m3]), lwd = 2, xlab = "Residuals", axes = FALSE, main = FALSE)
axis(1)
axis(2, las = 1)
```
...
plot(approx_dt[, res_bole_m3], pch = 19, cex = 0.4, xlab = "", ylab = "Residuals bole")
plot(approx_dt[, res_crown_m3], pch = 19, cex = 0.4, xlab = "", ylab = "Residuals crown")
plot(approx_dt[, res_tot_m3], pch = 19, cex = 0.4, xlab = "", ylab = "Residuals tot")
```
...
plot(forest_dt[, bole_volume_m3], sim_bole, pch = 19, col = forest_dt[, fct_colour], cex = 0.2,
	xlab = "Measured bole volume (m³)", ylab = "Predicted bole volume (m³)", axes = FALSE, asp = 1)
abline(a = 0, b = 1, lwd = 2, col = "#020202")
axis(1)
axis(2, las = 1)
legend(x = "topleft", bty = "n", legend = c("conifer", "broadleaf"), fill = colours[c("conifer", "broadleaf")])
...
axis(1)
axis(2, las = 1)
legend(x = "topleft", bty = "n", legend = c("NFI", "Inra"), fill = colours[c("nfi", "inra")])
```
...
plot(approx_dt[, crown_volume_m3], approx_dt[, sim_crown_m3], pch = 19, col = approx_dt[, fct_colour],
	cex = 0.2, xlab = "Measured crown volume (m³)", ylab = "Predicted crown volume (m³)", axes = FALSE, asp = 1)
abline(a = 0, b = 1, lwd = 2, col = "#020202")
axis(1)
axis(2, las = 1)
legend(x = "topleft", bty = "n", legend = c("conifer", "broadleaf"), fill = colours[c("conifer", "broadleaf")])
...
plot(approx_dt[, total_volume_m3], approx_dt[, sim_tot_m3], pch = 19, col = approx_dt[, fct_colour], cex = 0.2,
	xlab = "Total measured volume", ylab = "Avg volume", axes = FALSE, asp = 1)
abline(a = 0, b = 1, lwd = 2, col = "#020202")
axis(1)
axis(2, las = 1)
...
plot(approx_dt[, total_volume_m3], approx_dt[, mean_v_tot_pred], pch = 19, col = approx_dt[, fct_colour], cex = 0.2,
	xlab = "Total measured volume", ylab = "Approx sum logN avg volume", axes = FALSE, asp = 1)
abline(a = 0, b = 1, lwd = 2, col = "#020202")
axis(1)
axis(2, las = 1)
legend(x = "topright", legend = c("conifer", "broadleaf"), fill = colours[c("conifer", "broadleaf")])
...
### Prediction on an independent dataset and comparison with `inventR::TarEmerge`