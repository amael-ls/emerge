...
emerge_2009 = merge.data.table(x = unique(emerge_bure09_branches[, .(tree_id, branch_volume)]),
	y = unique(emerge_bure09_profils[, .(tree_id, bole_volume_conic_m3)]), all.y = TRUE)

emerge_2009 = merge.data.table(emerge_2009, emerge_bure09_arbres[, .(tree, id_codesforets,
	id_codesessences, circumference_m = c130, twig_volume = v_menu_verif)], by.x = "tree_id", by.y = "tree")

emerge_2009 = merge.data.table(emerge_2009, codesessences[, .(essence, speciesName_sci, fct_type)],
	by.x = "id_codesessences", by.y = "essence", all.x = TRUE)

emerge_bure09_arbres[, .(humidite_0a4, infradensite_0a4, humidite_4a7, infradensite_4a7,
	test = poids_fagots_0a4cm*humidite_0a4/infradensite_0a4 +
	poids_fagots_4a7cm*humidite_4a7/infradensite_4a7, v_menu_verif)]

emerge_bure09_arbres[, .(test, v_menu_verif)]
...
emerge_2010 = merge.data.table(x = unique(emerge_2010_branches[, .(tree_id, branch_volume)]),
	y = unique(emerge_2010_profils[, .(tree_id, bole_volume_conic_m3)]), all.y = TRUE)

emerge_2010 = merge.data.table(emerge_2010, emerge_2010_arbres[, .(tree, id_codesforets,
	id_codesessences, c130, v_menu_verif)], by.x = "tree_id", by.y = "tree")

# emerge_2010[is.na(branch_volume)] # I checked, v_br_verif is set to 0 in this case, so no branch

emerge_2010_arbres[, poids_fagots_0a4cm - poids_fagots_0a4cm_verif]
emerge_2010_arbres[, check_weight := total_poids_fagots - (poids_fagots_0a4cm + poids_fagots_4a7cm +
	poids_fagots_7a20cm + poids_fagots_sup20cm)]

emerge_2010_arbres[, plot(density(check_weight))]

emerge_2010_arbres[, .(tree, species, c130, prop_bois_bas_houppier_pourcent,
	poids_fagots_0a4cm, poids_fagots_4a7cm,
	humidite_0a4, infradensite_0a4, humidite_4a7, infradensite_4a7,
	v_menu_verif)]

# Ok, je valide les poids car je ne sais pas ce qu'ils ont foutu pour les 18 eucalyptus de merde

emerge_2010_arbres[, total_poids_fagots]





emerge_2010_arbres[, 100 - (prop_bois_bas_houppier_pourcent + prop_feuilles_bas_houppier_pourcent)]

r$> sort(colnames(emerge_2010_arbres))
 [1] "brin_taillis"                            
 [2] "c130"                                    
 [3] "cmax_grossebranche"                      
 [4] "commentaire"                             
 [5] "ctronc_grossebranche"                    
 [6] "date"                                    
 [7] "distance_trou_generatrice"               
 [8] "h_fourche1_m"                            
 [9] "h_fourche2_m"                            
[10] "h_fourche3_m"                            
[11] "h_fourche4_m"                            
...
[17] "id_codesessences"                        
[18] "id_codesforets"                          
[19] "id_codesorganismes"                      
[20] "id_codesstructures"                      
[21] "infradensite_0a4"                        
[22] "infradensite_4a7"                        
[23] "insersion_1ere_branche_vivante_m"        
[24] "longueur_arbre_m"                        
[25] "longueur_d4_m"                           
[26] "longueur_d7_m"                           
[27] "parcelle"                                
[28] "poids_fagots_0a4_bas"                    
[29] "poids_fagots_0a4cm"                      
[30] "poids_fagots_0a4cm_cime"                 
[31] "poids_fagots_0a4cm_haut"                 
[32] "poids_fagots_0a4cm_milieu"               
[33] "poids_fagots_0a4cm_mort"                 
[34] "poids_fagots_0a4cm_verif"                
[35] "poids_fagots_0a4cm_vivant"               
[36] "poids_fagots_4a7_cime"                   
[37] "poids_fagots_4a7cm"                      
[38] "poids_fagots_4a7cm_mort"                 
[39] "poids_fagots_4a7cm_vivant"               
[40] "poids_fagots_7a20cm"                     
[41] "poids_fagots_cime_peses"                 
[42] "poids_fagots_sup20cm"                    
[43] "poids_tronc_humide_kg"                   
[44] "prop_bois_bas_houppier_pourcent"         
[45] "prop_bois_haut_houppier_pourcent"        
[46] "prop_boismort_milieu_houppier_pourcent"  
[47] "prop_boisvivant_milieu_houppier_pourcent"
[48] "prop_feuilles_bas_houppier_pourcent"     
[49] "prop_feuilles_haut_houppier_pourcent"    
[50] "prop_feuilles_milieu_houppier_pourcent"  
[51] "prop_fruits_bas_houppier_pourcent"       
[52] "prop_fruits_haut_houppier_pourcent"      
[53] "prop_fruits_milieu_houppier_pourcent"    
[54] "site"                                    
[55] "species"                                 
[56] "total_poids_fagots"                      
[57] "total_poids_tronc_fagots_humide_kg"      
[58] "tree"                                    
[59] "trou_contrainte"                         
[60] "v_br_verif"                              
[61] "v_menu_verif"                            
[62] "v_tronc_cone_verif"                      
[63] "v_tronc_cylindre_verif"                  
[64] "volume_tronc_branches_humide"            
[65] "volume_tronc_humide"  
```

```{r}
# trees_2010 = merge.data.table(unique(emerge_2010_branches[, .(tree_id, branch_volume)]),
