...
## Predictions uncorrelated model
pred_bole_volume_uncor = fit_uncor$draws("pred_bole_volume")
pred_crown_volume_uncor = fit_uncor$draws("pred_crown_volume")
...
## Bole volume
sim_dharma = dharma_helper(simResp = pred_bole_volume, obs = inra_dec[, bole_volume_m3])
plot(sim_dharma, quantreg = TRUE)
plotResiduals(sim_dharma, inra_dec[, circumference_m], quantreg = TRUE)

## Crown volume
sim_dharma = dharma_helper(simResp = pred_crown_volume, obs = inra_dec[, crown_volume_m3])
plot(sim_dharma, quantreg = TRUE)
plotResiduals(sim_dharma, inra_dec[, circumference_m], quantreg = TRUE)
...
## Bole volume
sim_dharma = dharma_helper(simResp = pred_bole_volume_uncor, obs = inra_dec[, bole_volume_m3])
plot(sim_dharma, quantreg = TRUE)
plotResiduals(sim_dharma, inra_dec[, circumference_m], quantreg = TRUE)

## Crown volume
sim_dharma = dharma_helper(simResp = pred_crown_volume_uncor, obs = inra_dec[, crown_volume_m3])
plot(sim_dharma, quantreg = TRUE)
plotResiduals(sim_dharma, inra_dec[, circumference_m], quantreg = TRUE)
...
#### Residuals correlated model
## Bole volume
sim_dharma = dharma_helper(simResp = pred_bole_volume, obs = data[, v_bft])
plot(sim_dharma, quantreg = TRUE)
plotResiduals(sim_dharma, data[, circumference_m], quantreg = TRUE)

## Crown volume
sim_dharma = dharma_helper(simResp = pred_crown_volume, obs = data[, v_crown])
plot(sim_dharma, quantreg = TRUE)
plotResiduals(sim_dharma, data[, circumference_m], quantreg = TRUE)
...
#### Residuals uncorrelated model
## Bole volume
sim_dharma = dharma_helper(simResp = pred_bole_volume_uncor, obs = data[, v_bft])
plot(sim_dharma, quantreg = TRUE)
plotResiduals(sim_dharma, data[, circumference_m], quantreg = TRUE)

## Crown volume
sim_dharma = dharma_helper(simResp = pred_crown_volume_uncor, obs = data[, v_crown])
plot(sim_dharma, quantreg = TRUE)
plotResiduals(sim_dharma, data[, circumference_m], quantreg = TRUE)
