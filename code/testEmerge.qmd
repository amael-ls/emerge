...
generated quantities {
	array[N_new] real volume_new = normal_rng((beta0[species_id] + b1[fct_type]*hdn_new + beta2[species_id]*slenderness_new) .*
		corrected_cyl_vol_new, sigma);
}
```
...
genQ = cmdstan_model("posteriorPred.stan")
...
#| fig-cap: "Predicted vs observed volume for Quercus petrae"
#| fig-asp: 1
#| out-width: 95%
#| fig-width: 9
par(mar = c(5, 5, 1, 1))
