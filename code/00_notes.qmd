...
Note that I made the test with $\sigma = 35$ (instead of $\sigma = `{r} sigma`$). In other words, I put the data less informative. It was  still working, although the parameters' variance increased a lot (makes sense!). I do not show these results.
